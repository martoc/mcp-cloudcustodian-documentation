# Description: Makefile for Python MCP Cloud Custodian Documentation Server

PROJECT_NAME := mcp-cloudcustodian-documentation
TARGET := ./target
...
index: ## Build the documentation index
	...
	$(PYTHON) -m mcp_cloudcustodian_documentation.cli index

.PHONY: run
run: ## Run the MCP server
	@echo "==> Running MCP server..."
	$(PYTHON) -m mcp_cloudcustodian_documentation.server

DOCKER_IMAGE := mcp-cloudcustodian-documentation
